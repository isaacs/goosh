...
//    output.innerHTML += "COMMAND:"+cmdstr+"/"+query+"/"+this.name+".<br/>"; // debug
    ...
    goosh.ajax.query("http://ajax.googleapis.com/ajax/services/feed/load?v=1.0&hl="+goosh.config.lang+"&callback=goosh.modobj."+this.name+".render&num=100&scoring=h&q="+encodeURIComponent(query)+"&key="+goosh.config.apikey);
  }
  ...
  //  output.innerHTML += "lookup:"+cmdstr+"/"+query+"/"+this.name+".<br/>"; // debug
    ...
    goosh.ajax.query("http://ajax.googleapis.com/ajax/services/feed/lookup?v=1.0&hl="+goosh.config.lang+"&callback=goosh.modobj."+this.name+".lookupdone&q="+encodeURIComponent(query)+"&key="+goosh.config.apikey);
  }
