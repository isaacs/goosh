...
goosh.module.feeds = function(){
  ...
  this.query = function(cmdstr,query) {
    ...
    goosh.ajax.query("http://ajax.googleapis.com/ajax/services/feed/find?v=1.0&hl="+goosh.config.lang+"&callback=goosh.modobj."+this.name+".render&q="+encodeURIComponent(query)+'&num=100&key'+goosh.config.apikey+"&");
  }
